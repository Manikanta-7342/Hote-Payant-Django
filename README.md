...
Open-source **[Django Dashboard](https://appseed.us/admin-dashboards/django)** generated by AppSeed op top of a modern design. **Volt Dashboard** is a free and open source **[Bootstrap 5](https://appseed.us/admin-dashboards/django-dashboard-volt)** Admin Dashboard featuring over 100 components, 11 example pages and 3 plugins with Vanilla JS. There are more than 100 free Bootstrap 5 components included some of them being buttons, alerts, modals, datepickers and so on.
...
< PROJECT ROOT >
   |
   |-- intern/                               # Implements app configuration
   ...
   |
   |    
   |-- hote/                          # A simple app that serve HTML files
   |     |-- views.py                  # Serve HTML pages for authenticated users
   |     |-- urls.py                   # Define some super simple routes  
   |    
   |-- accounts/                # Handles auth routes (login and register)
   |        |-- urls.py                   # Define authentication routes  
   |        |-- views.py                  # Handles login and registration  
   |                         # Define auth forms (login and register) 
   |    
   |-- static/
   |        |-- <styles, js, images,plugins>         # CSS files, Javascripts files
   |    
   |--template/                     # Templates used to render pages
   ...
   |         |-- index.html
   |         |--forgot-password.html              # All other pages
   |
   |-- requirements.txt                     # Development modules - SQLite storage
   |
   |                                 # Inject Configuration via Environment
